...
def generate_transactions(
    ...
    offsets = np.cumsum(rng.exponential(scale=total_seconds / n_samples, size=n_samples))
    ...
    if current_fraud < target_fraud:
        ...
        is_fraud[rng.choice(non_fraud_idx, size=target_fraud - current_fraud, replace=False)] = True
...
def main() -> None:
    ...
    parser.add_argument("--fraud-rate", type=float, default=0.022)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--output", type=str, default="data/raw/transactions.parquet")
